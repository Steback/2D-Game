...
private:
    ...
    void CreateSamplers();
    void EnsureVsShader(uint32_t n);
    void EnsurePsShader(uint32_t n);
    void EnsureProgram(uint32_t n);
    void CreatePrograms();
...
private:
    ...
    struct ProgramInfo
    {
        ...
        GLint textSizeLocation;
        GLint textPixelSizeLocation;
    ...
    GLuint mVsShaders[11];
    GLuint mPsShaders[48];
